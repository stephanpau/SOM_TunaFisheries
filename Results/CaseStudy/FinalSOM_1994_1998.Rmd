...
df <- df[df$FishMode=="FAD",] %>% #select only sets on fish aggregating devices
  ...
  filter(YearC %in% c(1994:1998)) %>% #select years
...
df.1994 <- df.final[df.final$YearC==1994,]
for(j in 1:6){
  print(ggplot() + geom_sf(data=world) + labs(x = "longitude",y ="latitude") + coord_sf(xlim= c(-35,20), ylim = c(-30,30)) +
    ...
    geom_point(data = df.1994[df.1994$TimePeriodID==j,], aes(x = xLon, y = yLat, col = as.factor(FAL)), alpha = 0.7, pch = 15) +
    theme_minimal()+
    theme(axis.text = element_text(size=10), axis.title = element_text(size = 12), legend.text = element_text(size=10), legend.title = element_text(size=10), legend.key.size = unit(0.4, "cm"), plot.title = element_text(size=14), legend.position = "bottom") + labs(title = paste("Year 1994, month", j), subtitle = "Data check FAL"))
}

#compare with df
df.tuna.1994 <- df[df$YearC==1994,]
for(j in 1:6){
  print(ggplot() + geom_sf(data=world) + labs(x = "longitude",y ="latitude") + coord_sf(xlim= c(-35,20), ylim = c(-30,30)) +
    #geom_count(data = df, aes(x = xLon, y = yLat), alpha = 0.4,  col = "gray") +
    geom_point(data = df.tuna.1994[df.tuna.1994$TimePeriodID==j,], aes(x = xLon, y = yLat), alpha = 0.7, pch = 15) +
    theme_minimal()+
    theme(axis.text = element_text(size=10), axis.title = element_text(size = 12), legend.text = element_text(size=10), legend.title = element_text(size=10), legend.key.size = unit(0.4, "cm"), plot.title = element_text(size=14), legend.position = "bottom") + labs(title = paste("Year 1994, month", j), subtitle = "Data check FAL"))
}
```
...
```{r, echo=TRUE }
#select year 1994
df.1994 <- df.final %>% filter(YearC == 1994) %>% ungroup() %>% select(xLon, yLat, TimePeriodID, BET, YFT, SKJ, FAL) #%>% drop_na()
df.1994$obsID <- group_indices(df.1994 ,TimePeriodID, xLon, yLat)
...
df.1994 <- df.1994 %>% inner_join(clusters, by = "obsID")
```

```{r, echo=FALSE }
#Boxplots
##BET
ggplot(data=df.1994, aes(group = cluster.Ward, y=BET)) + geom_boxplot(aes(fill = as.factor(cluster.Ward))) + scale_fill_manual(breaks = c(0:15), values = Clusters.col, labels = c(0:15)) + labs(title = "BET by cluster", subtitle = "Year 1994") + theme_minimal() +
...
##YFT
ggplot(data=df.1994, aes(group = cluster.Ward, y=YFT)) + geom_boxplot(aes(fill = as.factor(cluster.Ward))) + scale_fill_manual(breaks = c(0:15), values = Clusters.col, labels = c(0:15)) + labs(title = "YFT by cluster", subtitle = "Year 1994") + theme_minimal() +
  theme(axis.text = element_text(size=9), axis.title = element_text(size = 10), 
        legend.text = element_text(size=10), legend.title = element_text(size=10), 
        legend.key.size = unit(0.4, "cm"), plot.title = element_text(size=12), legend.position = "bottom",
        plot.caption = element_text(hjust = 0, size = 9, face = "italic"))+
...
##SKJ
ggplot(data=df.1994, aes(group = cluster.Ward, y=SKJ)) + geom_boxplot(aes(fill = as.factor(cluster.Ward))) + scale_fill_manual(breaks = c(0:15), values = Clusters.col, labels = c(0:15)) + labs(title = "SKJ by cluster",  subtitle = "Year 1994") + theme_minimal() +
  theme(axis.text = element_text(size=9), axis.title = element_text(size = 10), 
        legend.text = element_text(size=10), legend.title = element_text(size=10), 
        legend.key.size = unit(0.4, "cm"), plot.title = element_text(size=12), legend.position = "bottom",
        plot.caption = element_text(hjust = 0, size = 9, face = "italic"))+
...
#FAL
ggplot(data=df.1994, aes(group = cluster.Ward, y=FAL)) + geom_histogram() + geom_histogram(aes(fill = as.factor(cluster.Ward))) + scale_fill_manual(breaks = c(0:15), values = Clusters.col, labels = c(0:15))+ labs(title = "FAL abundance index by cluster", subtitle = "Year 1994") + theme_minimal() +
  theme(axis.text = element_text(size=9), axis.title = element_text(size = 10), 
        legend.text = element_text(size=10), legend.title = element_text(size=10), 
        legend.key.size = unit(0.4, "cm"), plot.title = element_text(size=12), legend.position = "bottom",
        plot.caption = element_text(hjust = 0, size = 9, face = "italic"))+
...
#geographic map
for(j in 1:12){
  print(ggplot() + geom_sf(data = world) + geom_point(data = df.1994[df.1994$TimePeriodID == j,], aes(x = xLon, y = yLat, color = as.factor(cluster.Ward)), pch = 15) + scale_colour_manual(breaks = c(0:15), values = Clusters.col, labels = c(0:15)) + theme_bw() + labs(title = "Year 1994", subtitle = paste("Month", j)) + coord_sf(xlim = c(-40,20), ylim = c(-25,25), expand = FALSE)+ guides(colour = guide_legend(title ="Clusters")))}
```
...
```{r }
#For TUNAS
df.medians <- df.1994 %>% group_by(cluster.Ward) %>% summarise(BET = median(BET), YFT = median(YFT), SKJ = median(SKJ), FAL = median(FAL))
...
df.visual <- df.1994 %>% filter(cluster.Ward %in% BET.YFT.medians)
for(j in 1:12){
...
df.visual <- df.1994 %>% filter(cluster.Ward %in% FAL.medians)
for(j in 1:12){
  print(ggplot() + geom_sf(data = world) + geom_point(data = df.visual[df.visual$TimePeriodID == j,], aes(x = xLon, y = yLat, color = as.factor(cluster.Ward)), pch = 15) + 
          scale_colour_manual(breaks = c(0:15), values = Clusters.col, labels = c(0:15)) + 
...
df.medians <- df.1994 %>% group_by(cluster.Ward) %>% summarise(BET = median(BET), YFT = median(YFT), SKJ = median(SKJ)) %>% #create tuna vulnerability index by column
...
df.1994 <- df.1994 %>% inner_join(df.medians, by = "cluster.Ward")

#replot boxplots with vulnerability colors
##BET
ggplot(data=df.1994, aes(group = cluster.Ward, y=BET)) + geom_boxplot(aes(fill = as.factor(vulnerability.tuna))) + scale_fill_manual(breaks = c(1:10), values = rev(Vulnerability.col), labels = c(1:10)) + labs(title = "BET by cluster", subtitle = "Ward") + theme_minimal() +
  theme(axis.text = element_text(size=9), axis.title = element_text(size = 10), 
        legend.text = element_text(size=10), legend.title = element_text(size=10), 
        legend.key.size = unit(0.4, "cm"), plot.title = element_text(size=12), legend.position = "bottom",
        plot.caption = element_text(hjust = 0, size = 9, face = "italic"))+
...
##YFT
ggplot(data=df.1994, aes(group = cluster.Ward, y=YFT)) + geom_boxplot(aes(fill = as.factor(vulnerability.tuna))) + scale_fill_manual(breaks = c(1:10), values = rev(Vulnerability.col), labels = c(1:10)) + labs(title = "YFT by cluster", subtitle = "Ward") + theme_minimal() +
  theme(axis.text = element_text(size=9), axis.title = element_text(size = 10), 
        legend.text = element_text(size=10), legend.title = element_text(size=10), 
        legend.key.size = unit(0.4, "cm"), plot.title = element_text(size=12), legend.position = "bottom",
        plot.caption = element_text(hjust = 0, size = 9, face = "italic"))+
...
for(j in 1:12){
  print(ggplot() + geom_sf(data = world) + geom_point(data = df.1994[df.1994$TimePeriodID == j,], aes(x = xLon, y = yLat, color = as.factor(vulnerability.tuna)), pch = 15) + scale_colour_manual(values = rev(Vulnerability.col[1:10]), breaks = c(1:10), labels = (1:10)) + theme_bw() + labs(title = "Vulnerability of tuna species", subtitle = paste("Month", j)) + coord_sf(xlim = c(-40,20), ylim = c(-25,25), expand = FALSE)+ guides(colour = guide_legend(title ="Vulnerability")))}
```
...
##create column
df.medians <- df.1994 %>% group_by(cluster.Ward) %>% summarise(BET = median(BET), YFT = median(YFT), SKJ = median(SKJ), FAL = median(FAL)) %>% #create tuna vulnerability index by column
...
#plot maps with color based on vulnerability in r
for(j in 1:12){
  print(ggplot() + geom_sf(data = world) + geom_point(data = df.1994[df.1994$TimePeriodID == j,], aes(x = xLon, y = yLat, color = as.factor(vulnerability.accessory)), pch = 15) + scale_colour_manual(breaks = c(1:10),values = rev(Vulnerability.col[1:10]), labels = (1:10)) + theme_bw() + labs(title = "Vulnerability of accessory species", subtitle = paste("Month", j)) + coord_sf(xlim = c(-40,20), ylim = c(-25,25), expand = FALSE)+ guides(colour = guide_legend(title ="Vulnerability")))}
```

# SOM analysis: 1995
```{r, echo=TRUE }
#select year 1995
df.1995 <- df.final %>% filter(YearC == 1995) %>% ungroup() %>% select(xLon, yLat, TimePeriodID, BET, YFT, SKJ, FAL) %>% drop_na()
df.1995$obsID <- group_indices(df.1995,TimePeriodID, xLon, yLat)
...
nodes <- as_tibble(som$unit.classif) %>% rowid_to_column(var = "obsID") %>% mutate(node = value) %>% select(-value)
clusters <- inner_join(nodes, clusters, by = "node")
df.1995 <- df.1995 %>% inner_join(clusters, by = "obsID")
```

```{r, echo=FALSE }
#Boxplots
##BET
ggplot(data=df.1995, aes(group = cluster.Ward, y=BET)) + geom_boxplot(aes(fill = as.factor(cluster.Ward))) + scale_fill_manual(breaks = c(0:15), values = Clusters.col, labels = c(0:15)) + labs(title = "BET by cluster", subtitle = "Year 1995") + theme_minimal() +
  theme(axis.text = element_text(size=9), axis.title = element_text(size = 10), 
        legend.text = element_text(size=10), legend.title = element_text(size=10), 
        legend.key.size = unit(0.4, "cm"), plot.title = element_text(size=12), legend.position = "bottom",
        plot.caption = element_text(hjust = 0, size = 9, face = "italic"))+
...
##YFT
ggplot(data=df.1995, aes(group = cluster.Ward, y=YFT)) + geom_boxplot(aes(fill = as.factor(cluster.Ward))) + scale_fill_manual(breaks = c(0:15), values = Clusters.col, labels = c(0:15)) + labs(title = "YFT by cluster", subtitle = "Year 1995") + theme_minimal() +
  theme(axis.text = element_text(size=9), axis.title = element_text(size = 10), 
        legend.text = element_text(size=10), legend.title = element_text(size=10), 
        legend.key.size = unit(0.4, "cm"), plot.title = element_text(size=12), legend.position = "bottom",
        plot.caption = element_text(hjust = 0, size = 9, face = "italic"))+
...
##SKJ
ggplot(data=df.1995, aes(group = cluster.Ward, y=SKJ)) + geom_boxplot(aes(fill = as.factor(cluster.Ward))) + scale_fill_manual(breaks = c(0:15), values = Clusters.col, labels = c(0:15)) + labs(title = "SKJ by cluster",  subtitle = "Year 1995") + theme_minimal() +
  theme(axis.text = element_text(size=9), axis.title = element_text(size = 10), 
        legend.text = element_text(size=10), legend.title = element_text(size=10), 
        legend.key.size = unit(0.4, "cm"), plot.title = element_text(size=12), legend.position = "bottom",
        plot.caption = element_text(hjust = 0, size = 9, face = "italic"))+
...
#FAL
ggplot(data=df.1995, aes(group = cluster.Ward, y=FAL)) + geom_histogram() + geom_histogram(aes(fill = as.factor(cluster.Ward))) + scale_fill_manual(breaks = c(0:15), values = Clusters.col, labels = c(0:15))+ labs(title = "FAL abundance index by cluster", subtitle ="Year 1995") + theme_minimal() +
  theme(axis.text = element_text(size=9), axis.title = element_text(size = 10), 
        legend.text = element_text(size=10), legend.title = element_text(size=10), 
        legend.key.size = unit(0.4, "cm"), plot.title = element_text(size=12), legend.position = "bottom",
        plot.caption = element_text(hjust = 0, size = 9, face = "italic"))+
...
#geographic map
for(j in 1:12){
  print(ggplot() + geom_sf(data = world) + geom_point(data = df.1995[df.1995$TimePeriodID == j,], aes(x = xLon, y = yLat, color = as.factor(cluster.Ward)), pch = 15) + scale_colour_manual(breaks = c(0:15), values = Clusters.col, labels = c(0:15)) + theme_bw() + labs(title = "Year 1995", subtitle = paste("Month", j)) + coord_sf(xlim = c(-40,20), ylim = c(-25,25), expand = FALSE)+ guides(colour = guide_legend(title ="Clusters")))}
```
...
```{r }
#For TUNAS
df.medians <- df.1995 %>% group_by(cluster.Ward) %>% summarise(BET = median(BET), YFT = median(YFT), SKJ = median(SKJ), FAL = median(FAL))
...
##bind two vectors 
BET.YFT.medians <- rbind(BET.medians, YFT.medians)
df.visual <- df.1995 %>% filter(cluster.Ward %in% BET.YFT.medians)
for(j in 1:12){
  print(ggplot() + geom_sf(data = world) + geom_point(data = df.visual[df.visual$TimePeriodID == j,], aes(x = xLon, y = yLat, color = as.factor(cluster.Ward)), pch = 15) + 
          scale_colour_manual(breaks = c(0:15), values = Clusters.col, labels = c(0:15)) + 
          theme_bw() + labs(title = "High YFT and BET abundance clusters", subtitle = paste("Month", j)) + coord_sf(xlim = c(-40,20), ylim = c(-25,25), expand = FALSE)+ guides(colour = guide_legend(title ="Clusters")))}
...
## visualise in geographic space
df.visual <- df.1995 %>% filter(cluster.Ward %in% FAL.medians)
for(j in 1:12){
  print(ggplot() + geom_sf(data = world) + geom_point(data = df.visual[df.visual$TimePeriodID == j,], aes(x = xLon, y = yLat, color = as.factor(cluster.Ward)), pch = 15) + 
          scale_colour_manual(breaks = c(0:15), values = Clusters.col, labels = c(0:15)) + 
          theme_bw() + labs(title = "High FAL abundance clusters", subtitle = paste("Month", j)) + coord_sf(xlim = c(-40,20), ylim = c(-25,25), expand = FALSE)+ guides(colour = guide_legend(title ="Clusters")))}
...
#take again this df.median
df.medians <- df.1995 %>% group_by(cluster.Ward) %>% summarise(BET = median(BET), YFT = median(YFT), SKJ = median(SKJ)) %>% #create tuna vulnerability index by column
  mutate(vulnerability.tuna = round((fac.BET*BET + fac.YFT*YFT + fac.SKJ *SKJ)/((fac.BET+fac.YFT+fac.SKJ)*1000))) %>%
  mutate(vulnerability.tuna = round(rescale(vulnerability.tuna, c(1,10)))) %>% #rescale to have values between 1 and 10
  arrange(desc(vulnerability.tuna)) %>%#arrange clusters by vulnerability
  select(cluster.Ward, vulnerability.tuna) #select only 2 columns of interest
...
#bind this vulnerability value to complete dataframe for plotting catches on map
df.1995 <- df.1995 %>% inner_join(df.medians, by = "cluster.Ward")

#replot boxplots with vulnerability colors
##BET
ggplot(data=df.1995, aes(group = cluster.Ward, y=BET)) + geom_boxplot(aes(fill = as.factor(vulnerability.tuna))) + scale_fill_manual(breaks = c(1:10), values = rev(Vulnerability.col), labels = c(1:10)) + labs(title = "BET by cluster", subtitle = "Ward") + theme_minimal() +
  theme(axis.text = element_text(size=9), axis.title = element_text(size = 10), 
        legend.text = element_text(size=10), legend.title = element_text(size=10), 
        legend.key.size = unit(0.4, "cm"), plot.title = element_text(size=12), legend.position = "bottom",
        plot.caption = element_text(hjust = 0, size = 9, face = "italic"))+
...
##YFT
ggplot(data=df.1995, aes(group = cluster.Ward, y=YFT)) + geom_boxplot(aes(fill = as.factor(vulnerability.tuna))) + scale_fill_manual(breaks = c(1:10), values = rev(Vulnerability.col), labels = c(1:10)) + labs(title = "YFT by cluster", subtitle = "Ward") + theme_minimal() +
  theme(axis.text = element_text(size=9), axis.title = element_text(size = 10), 
        legend.text = element_text(size=10), legend.title = element_text(size=10), 
        legend.key.size = unit(0.4, "cm"), plot.title = element_text(size=12), legend.position = "bottom",
        plot.caption = element_text(hjust = 0, size = 9, face = "italic"))+
...
#plot maps with color based on vulnerability in r
for(j in 1:12){
  print(ggplot() + geom_sf(data = world) + geom_point(data = df.1995[df.1995$TimePeriodID == j,], aes(x = xLon, y = yLat, color = as.factor(vulnerability.tuna)), pch = 15) + scale_colour_manual(values = rev(Vulnerability.col[1:10]), breaks = c(1:10), labels = (1:10)) + theme_bw() + labs(title = "Vulnerability of tuna species", subtitle = paste("Month", j)) + coord_sf(xlim = c(-40,20), ylim = c(-25,25), expand = FALSE)+ guides(colour = guide_legend(title ="Vulnerability", subtitle = "Tuna species")))}
```
...
##create column
df.medians <- df.1995 %>% group_by(cluster.Ward) %>% summarise(BET = median(BET), YFT = median(YFT), SKJ = median(SKJ), FAL = median(FAL)) %>% #create tuna vulnerability index by column
  mutate(vulnerability.accessory = (fac.FAL*FAL)) %>% #FAL a little more since more often bycaught
  mutate(vulnerability.accessory = round(rescale(vulnerability.accessory, c(1,10)))) %>% #rescale to have values between 0 and 10
  arrange(desc(vulnerability.accessory)) %>% #arrange clusters by vulnerability
  select(cluster.Ward, vulnerability.accessory) #select only 2 columns of interest
...
#plot maps with color based on vulnerability in r
for(j in 1:12){
  print(ggplot() + geom_sf(data = world) + geom_point(data = df.1995[df.1995$TimePeriodID == j,], aes(x = xLon, y = yLat, color = as.factor(vulnerability.accessory)), pch = 15) + scale_colour_manual(breaks = c(1:10),values = rev(Vulnerability.col[1:10]), labels = (1:10)) + theme_bw() + labs(title = "Vulnerability of accessory species", subtitle = paste("Month", j)) + coord_sf(xlim = c(-40,20), ylim = c(-25,25), expand = FALSE)+ guides(colour = guide_legend(title ="Vulnerability")))}
```
...
```{r, echo=TRUE }
#select year 1996
df.1996 <- df.final %>% filter(YearC == 1996) %>% ungroup() %>% select(xLon, yLat, TimePeriodID, obsID, BET, YFT, SKJ, FAL) %>% drop_na() 
df.1996$obsID <- group_indices(df.1996 ,TimePeriodID, xLon, yLat)
...
nodes <- as_tibble(som$unit.classif) %>% rowid_to_column(var = "obsID") %>% mutate(node = value) %>% select(-value)
clusters <- inner_join(nodes, clusters, by = "node")
df.1996 <- df.1996 %>% inner_join(clusters, by = "obsID")
```

```{r, echo=FALSE }
#Boxplots
##BET
ggplot(data=df.1996, aes(group = cluster.Ward, y=BET)) + geom_boxplot(aes(fill = as.factor(cluster.Ward))) + scale_fill_manual(breaks = c(0:15), values = Clusters.col, labels = c(0:15)) + labs(title = "BET by cluster", subtitle = "Year 1996") + theme_minimal() +
  theme(axis.text = element_text(size=9), axis.title = element_text(size = 10), 
        legend.text = element_text(size=10), legend.title = element_text(size=10), 
        legend.key.size = unit(0.4, "cm"), plot.title = element_text(size=12), legend.position = "bottom",
        plot.caption = element_text(hjust = 0, size = 9, face = "italic"))+
...
##YFT
ggplot(data=df.1996, aes(group = cluster.Ward, y=YFT)) + geom_boxplot(aes(fill = as.factor(cluster.Ward))) + scale_fill_manual(breaks = c(0:15), values = Clusters.col, labels = c(0:15)) + labs(title = "YFT by cluster", subtitle = "Year 1996") + theme_minimal() +
  theme(axis.text = element_text(size=9), axis.title = element_text(size = 10), 
        legend.text = element_text(size=10), legend.title = element_text(size=10), 
        legend.key.size = unit(0.4, "cm"), plot.title = element_text(size=12), legend.position = "bottom",
        plot.caption = element_text(hjust = 0, size = 9, face = "italic"))+
...
##SKJ
ggplot(data=df.1996, aes(group = cluster.Ward, y=SKJ)) + geom_boxplot(aes(fill = as.factor(cluster.Ward))) + scale_fill_manual(breaks = c(0:15), values = Clusters.col, labels = c(0:15)) + labs(title = "SKJ by cluster",  subtitle = "Year 1996") + theme_minimal() +
  theme(axis.text = element_text(size=9), axis.title = element_text(size = 10), 
        legend.text = element_text(size=10), legend.title = element_text(size=10), 
        legend.key.size = unit(0.4, "cm"), plot.title = element_text(size=12), legend.position = "bottom",
        plot.caption = element_text(hjust = 0, size = 9, face = "italic"))+
...
#FAL
ggplot(data=df.1996, aes(group = cluster.Ward, y=FAL)) + geom_histogram() + geom_histogram(aes(fill = as.factor(cluster.Ward))) + scale_fill_manual(breaks = c(0:15), values = Clusters.col, labels = c(0:15))+ labs(title = "FAL abundance index by cluster", subtitle ="Year 1996") + theme_minimal() +
  theme(axis.text = element_text(size=9), axis.title = element_text(size = 10), 
        legend.text = element_text(size=10), legend.title = element_text(size=10), 
        legend.key.size = unit(0.4, "cm"), plot.title = element_text(size=12), legend.position = "bottom",
        plot.caption = element_text(hjust = 0, size = 9, face = "italic"))+
...
#geographic map
for(j in 1:12){
  print(ggplot() + geom_sf(data = world) + geom_point(data = df.1996[df.1996$TimePeriodID == j,], aes(x = xLon, y = yLat, color = as.factor(cluster.Ward)), pch = 15) + scale_colour_manual(breaks = c(0:15), values = Clusters.col, labels = c(0:15)) + theme_bw() + labs(title = "Year 1996", subtitle = paste("Month", j)) + coord_sf(xlim = c(-40,20), ylim = c(-25,25), expand = FALSE)+ guides(colour = guide_legend(title ="Clusters")))}
```
...
```{r }
#For TUNAS
df.medians <- df.1996 %>% group_by(cluster.Ward) %>% summarise(BET = median(BET), YFT = median(YFT), SKJ = median(SKJ), FAL = median(FAL))
...
##bind two vectors 
BET.YFT.medians <- rbind(BET.medians, YFT.medians)
df.visual <- df.1996 %>% filter(cluster.Ward %in% BET.YFT.medians)
for(j in 1:12){
  print(ggplot() + geom_sf(data = world) + geom_point(data = df.visual[df.visual$TimePeriodID == j,], aes(x = xLon, y = yLat, color = as.factor(cluster.Ward)), pch = 15) + 
          scale_colour_manual(breaks = c(0:15), values = Clusters.col, labels = c(0:15)) + 
          theme_bw() + labs(title = "High YFT and BET abundance clusters", subtitle = paste("Month", j)) + coord_sf(xlim = c(-40,20), ylim = c(-25,25), expand = FALSE)+ guides(colour = guide_legend(title ="Clusters")))}
...
## visualise in geographic space
df.visual <- df.1996 %>% filter(cluster.Ward %in% FAL.medians)
for(j in 1:12){
  print(ggplot() + geom_sf(data = world) + geom_point(data = df.visual[df.visual$TimePeriodID == j,], aes(x = xLon, y = yLat, color = as.factor(cluster.Ward)), pch = 15) + 
          scale_colour_manual(breaks = c(0:15), values = Clusters.col, labels = c(0:15)) + 
          theme_bw() + labs(title = "High FAL abundance clusters", subtitle = paste("Month", j)) + coord_sf(xlim = c(-40,20), ylim = c(-25,25), expand = FALSE)+ guides(colour = guide_legend(title ="Clusters")))}
...
#take again this df.median
df.medians <- df.1996 %>% group_by(cluster.Ward) %>% summarise(BET = median(BET), YFT = median(YFT), SKJ = median(SKJ)) %>% #create tuna vulnerability index by column
  mutate(vulnerability.tuna = round((fac.BET*BET + fac.YFT*YFT + fac.SKJ *SKJ)/((fac.BET+fac.YFT+fac.SKJ)*1000))) %>%
  mutate(vulnerability.tuna = round(rescale(vulnerability.tuna, c(1,10)))) %>% #rescale to have values between 1 and 10
  arrange(desc(vulnerability.tuna)) %>%#arrange clusters by vulnerability
  select(cluster.Ward, vulnerability.tuna) #select only 2 columns of interest
...
#bind this vulnerability value to complete dataframe for plotting catches on map
df.1996 <- df.1996 %>% inner_join(df.medians, by = "cluster.Ward")

#replot boxplots with vulnerability colors
##BET
ggplot(data=df.1996, aes(group = cluster.Ward, y=BET)) + geom_boxplot(aes(fill = as.factor(vulnerability.tuna))) + scale_fill_manual(breaks = c(1:10), values = rev(Vulnerability.col), labels = c(1:10)) + labs(title = "BET by cluster", subtitle = "Ward") + theme_minimal() +
  theme(axis.text = element_text(size=9), axis.title = element_text(size = 10), 
        legend.text = element_text(size=10), legend.title = element_text(size=10), 
        legend.key.size = unit(0.4, "cm"), plot.title = element_text(size=12), legend.position = "bottom",
        plot.caption = element_text(hjust = 0, size = 9, face = "italic"))+
...
##YFT
ggplot(data=df.1996, aes(group = cluster.Ward, y=YFT)) + geom_boxplot(aes(fill = as.factor(vulnerability.tuna))) + scale_fill_manual(breaks = c(1:10), values = rev(Vulnerability.col), labels = c(1:10)) + labs(title = "YFT by cluster", subtitle = "Ward") + theme_minimal() +
  theme(axis.text = element_text(size=9), axis.title = element_text(size = 10), 
        legend.text = element_text(size=10), legend.title = element_text(size=10), 
        legend.key.size = unit(0.4, "cm"), plot.title = element_text(size=12), legend.position = "bottom",
        plot.caption = element_text(hjust = 0, size = 9, face = "italic"))+
...
#plot maps with color based on vulnerability in r
for(j in 1:12){
  print(ggplot() + geom_sf(data = world) + geom_point(data = df.1996[df.1996$TimePeriodID == j,], aes(x = xLon, y = yLat, color = as.factor(vulnerability.tuna)), pch = 15) + scale_colour_manual(values = rev(Vulnerability.col[1:10]), breaks = c(1:10), labels = (1:10)) + theme_bw() + labs(title = "Vulnerability of tuna species", subtitle = paste("Month", j)) + coord_sf(xlim = c(-40,20), ylim = c(-25,25), expand = FALSE)+ guides(colour = guide_legend(title ="Vulnerability", subtitle = "Tuna species")))}
```
...
##create column
df.medians <- df.1996 %>% group_by(cluster.Ward) %>% summarise(BET = median(BET), YFT = median(YFT), SKJ = median(SKJ), FAL = median(FAL)) %>% #create tuna vulnerability index by column
  mutate(vulnerability.accessory = (fac.FAL*FAL)) %>% #FAL a little more since more often bycaught
  mutate(vulnerability.accessory = round(rescale(vulnerability.accessory, c(1,10)))) %>% #rescale to have values between 0 and 10
  arrange(desc(vulnerability.accessory)) %>% #arrange clusters by vulnerability
  select(cluster.Ward, vulnerability.accessory) #select only 2 columns of interest
...
#plot maps with color based on vulnerability in r
for(j in 1:12){
  print(ggplot() + geom_sf(data = world) + geom_point(data = df.1996[df.1996$TimePeriodID == j,], aes(x = xLon, y = yLat, color = as.factor(vulnerability.accessory)), pch = 15) + scale_colour_manual(breaks = c(1:10),values = rev(Vulnerability.col[1:10]), labels = (1:10)) + theme_bw() + labs(title = "Vulnerability of accessory species", subtitle = paste("Month", j)) + coord_sf(xlim = c(-40,20), ylim = c(-25,25), expand = FALSE)+ guides(colour = guide_legend(title ="Vulnerability")))}
```
...
```{r, echo=TRUE }
#select year 1997
df.1997 <- df.final %>% filter(YearC == 1997) %>% ungroup() %>% select(xLon, yLat, TimePeriodID, obsID, BET, YFT, SKJ, FAL) %>% drop_na()
df.1997$obsID <- group_indices(df.1997,TimePeriodID, xLon, yLat)
...
nodes <- as_tibble(som$unit.classif) %>% rowid_to_column(var = "obsID") %>% mutate(node = value) %>% select(-value)
clusters <- inner_join(nodes, clusters, by = "node")
df.1997 <- df.1997 %>% inner_join(clusters, by = "obsID")
```

```{r, echo=FALSE }
#Boxplots
##BET
ggplot(data=df.1997, aes(group = cluster.Ward, y=(BET))) + geom_boxplot(aes(fill = as.factor(cluster.Ward))) + scale_fill_manual(breaks = c(0:15), values = Clusters.col, labels = c(0:15)) + labs(title = "BET by cluster", subtitle = "Year 1997") + theme_minimal() +
  theme(axis.text = element_text(size=9), axis.title = element_text(size = 10), 
        legend.text = element_text(size=10), legend.title = element_text(size=10), 
        legend.key.size = unit(0.4, "cm"), plot.title = element_text(size=12), legend.position = "bottom",
        plot.caption = element_text(hjust = 0, size = 9, face = "italic"))+
...
##YFT
ggplot(data=df.1997, aes(group = cluster.Ward, y= (YFT))) + geom_boxplot(aes(fill = as.factor(cluster.Ward))) + scale_fill_manual(breaks = c(0:15), values = Clusters.col, labels = c(0:15)) + labs(title = "YFT by cluster", subtitle = "Year 1997") + theme_minimal() +
  theme(axis.text = element_text(size=9), axis.title = element_text(size = 10), 
        legend.text = element_text(size=10), legend.title = element_text(size=10), 
        legend.key.size = unit(0.4, "cm"), plot.title = element_text(size=12), legend.position = "bottom",
        plot.caption = element_text(hjust = 0, size = 9, face = "italic"))+
...
##SKJ
ggplot(data=df.1997, aes(group = cluster.Ward, y= (SKJ))) + geom_boxplot(aes(fill = as.factor(cluster.Ward))) + scale_fill_manual(breaks = c(0:15), values = Clusters.col, labels = c(0:15)) + labs(title = "SKJ by cluster",  subtitle = "Year 1997") + theme_minimal() +
  theme(axis.text = element_text(size=9), axis.title = element_text(size = 10), 
        legend.text = element_text(size=10), legend.title = element_text(size=10), 
        legend.key.size = unit(0.4, "cm"), plot.title = element_text(size=12), legend.position = "bottom",
        plot.caption = element_text(hjust = 0, size = 9, face = "italic"))+
...
#FAL
ggplot(data=df.1997, aes(group = cluster.Ward, y=FAL)) + geom_histogram() + geom_histogram(aes(fill = as.factor(cluster.Ward))) + scale_fill_manual(breaks = c(0:15), values = Clusters.col, labels = c(0:15))+ labs(title = "FAL abundance index by cluster", subtitle ="Year 1997") + theme_minimal() +
  theme(axis.text = element_text(size=9), axis.title = element_text(size = 10), 
        legend.text = element_text(size=10), legend.title = element_text(size=10), 
        legend.key.size = unit(0.4, "cm"), plot.title = element_text(size=12), legend.position = "bottom",
        plot.caption = element_text(hjust = 0, size = 9, face = "italic"))+
...
#geographic map
for(j in 1:12){
  print(ggplot() + geom_sf(data = world) + geom_point(data = df.1997[df.1997$TimePeriodID == j,], aes(x = xLon, y = yLat, color = as.factor(cluster.Ward)), pch = 15) + scale_colour_manual(breaks = c(0:15), values = Clusters.col, labels = c(0:15)) + theme_bw() + labs(title = "Year 1997", subtitle = paste("Month", j)) + coord_sf(xlim = c(-40,20), ylim = c(-25,25), expand = FALSE)+ guides(colour = guide_legend(title ="Clusters")))}
```
...
```{r }
#For TUNAS
df.medians <- df.1997 %>% group_by(cluster.Ward) %>% summarise(BET = median(BET), YFT = median(YFT), SKJ = median(SKJ), FAL = median(FAL))
...
##bind two vectors 
BET.YFT.medians <- rbind(BET.medians, YFT.medians)
df.visual <- df.1997 %>% filter(cluster.Ward %in% BET.YFT.medians)
for(j in 1:12){
  print(ggplot() + geom_sf(data = world) + geom_point(data = df.visual[df.visual$TimePeriodID == j,], aes(x = xLon, y = yLat, color = as.factor(cluster.Ward)), pch = 15) + 
          scale_colour_manual(breaks = c(0:15), values = Clusters.col, labels = c(0:15)) + 
          theme_bw() + labs(title = "High YFT and BET abundance clusters", subtitle = paste("Month", j)) + coord_sf(xlim = c(-40,20), ylim = c(-25,25), expand = FALSE)+ guides(colour = guide_legend(title ="Clusters")))}
...
## visualise in geographic space
df.visual <- df.1997 %>% filter(cluster.Ward %in% FAL.medians)
for(j in 1:12){
  print(ggplot() + geom_sf(data = world) + geom_point(data = df.visual[df.visual$TimePeriodID == j,], aes(x = xLon, y = yLat, color = as.factor(cluster.Ward)), pch = 15) + 
          scale_colour_manual(breaks = c(0:15), values = Clusters.col, labels = c(0:15)) + 
          theme_bw() + labs(title = "High FAL abundance clusters", subtitle = paste("Month", j)) + coord_sf(xlim = c(-40,20), ylim = c(-25,25), expand = FALSE)+ guides(colour = guide_legend(title ="Clusters")))}
...
#take again this df.median
df.medians <- df.1997 %>% group_by(cluster.Ward) %>% summarise(BET = median(BET), YFT = median(YFT), SKJ = median(SKJ)) %>% #create tuna vulnerability index by column
  mutate(vulnerability.tuna = round((fac.BET*BET + fac.YFT*YFT + fac.SKJ *SKJ)/((fac.BET+fac.YFT+fac.SKJ)*1000))) %>%
  mutate(vulnerability.tuna = round(rescale(vulnerability.tuna, c(1,10)))) %>% #rescale to have values between 1 and 10
  arrange(desc(vulnerability.tuna)) %>%#arrange clusters by vulnerability
  select(cluster.Ward, vulnerability.tuna) #select only 2 columns of interest
...
#bind this vulnerability value to complete dataframe for plotting catches on map
df.1997 <- df.1997 %>% inner_join(df.medians, by = "cluster.Ward")

#replot boxplots with vulnerability colors
##BET
ggplot(data=df.1997, aes(group = cluster.Ward, y=BET)) + geom_boxplot(aes(fill = as.factor(vulnerability.tuna))) + scale_fill_manual(breaks = c(1:10), values = rev(Vulnerability.col), labels = c(1:10)) + labs(title = "BET by cluster", subtitle = "Ward") + theme_minimal() +
  theme(axis.text = element_text(size=9), axis.title = element_text(size = 10), 
        legend.text = element_text(size=10), legend.title = element_text(size=10), 
        legend.key.size = unit(0.4, "cm"), plot.title = element_text(size=12), legend.position = "bottom",
        plot.caption = element_text(hjust = 0, size = 9, face = "italic"))+
...
##YFT
ggplot(data=df.1997, aes(group = cluster.Ward, y=YFT)) + geom_boxplot(aes(fill = as.factor(vulnerability.tuna))) + scale_fill_manual(breaks = c(1:10), values = rev(Vulnerability.col), labels = c(1:10)) + labs(title = "YFT by cluster", subtitle = "Ward") + theme_minimal() +
  theme(axis.text = element_text(size=9), axis.title = element_text(size = 10), 
        legend.text = element_text(size=10), legend.title = element_text(size=10), 
        legend.key.size = unit(0.4, "cm"), plot.title = element_text(size=12), legend.position = "bottom",
        plot.caption = element_text(hjust = 0, size = 9, face = "italic"))+
...
#plot maps with color based on vulnerability in r
for(j in 1:12){
  print(ggplot() + geom_sf(data = world) + geom_point(data = df.1997[df.1997$TimePeriodID == j,], aes(x = xLon, y = yLat, color = as.factor(vulnerability.tuna)), pch = 15) + scale_colour_manual(values = rev(Vulnerability.col[1:10]), breaks = c(1:10), labels = (1:10)) + theme_bw() + labs(title = "Vulnerability of tuna species", subtitle = paste("Month", j)) + coord_sf(xlim = c(-40,20), ylim = c(-25,25), expand = FALSE)+ guides(colour = guide_legend(title ="Vulnerability")))}
```
...
##create column
df.medians <- df.1997 %>% group_by(cluster.Ward) %>% summarise(BET = median(BET), YFT = median(YFT), SKJ = median(SKJ), FAL = median(FAL)) %>% #create tuna vulnerability index by column
  mutate(vulnerability.accessory = (fac.FAL*FAL)) %>% #FAL a little more since more often bycaught
  mutate(vulnerability.accessory = round(rescale(vulnerability.accessory, c(1,10)))) %>% #rescale to have values between 0 and 10
  arrange(desc(vulnerability.accessory)) %>% #arrange clusters by vulnerability
  select(cluster.Ward, vulnerability.accessory) #select only 2 columns of interest
...
#plot maps with color based on vulnerability in r
for(j in 1:12){
  print(ggplot() + geom_sf(data = world) + geom_point(data = df.1997[df.1997$TimePeriodID == j,], aes(x = xLon, y = yLat, color = as.factor(vulnerability.accessory)), pch = 15) + scale_colour_manual(breaks = c(1:10),values = rev(Vulnerability.col[1:10]), labels = (1:10)) + theme_bw() + labs(title = "Vulnerability of accessory species", subtitle = paste("Month", j)) + coord_sf(xlim = c(-40,20), ylim = c(-25,25), expand = FALSE)+ guides(colour = guide_legend(title ="Vulnerability")))}
```
...
```{r, echo=TRUE }
#select year 1998
df.1998 <- df.final %>% filter(YearC == 1998) %>% ungroup() %>% select(xLon, yLat, TimePeriodID, obsID, BET, YFT, SKJ, FAL) %>% drop_na()
df.1998$obsID <- group_indices(df.1998,TimePeriodID, xLon, yLat)
...
nodes <- as_tibble(som$unit.classif) %>% rowid_to_column(var = "obsID") %>% mutate(node = value) %>% select(-value)
clusters <- inner_join(nodes, clusters, by = "node")
df.1998 <- df.1998 %>% inner_join(clusters, by = "obsID")
```

```{r, echo=FALSE }
#Boxplots
##BET
ggplot(data=df.1998, aes(group = cluster.Ward, y= (BET))) + geom_boxplot(aes(fill = as.factor(cluster.Ward))) + scale_fill_manual(breaks = c(0:15), values = Clusters.col, labels = c(0:15)) + labs(title = "BET by cluster", subtitle = "Year 1998") + theme_minimal() +
  theme(axis.text = element_text(size=9), axis.title = element_text(size = 10), 
        legend.text = element_text(size=10), legend.title = element_text(size=10), 
        legend.key.size = unit(0.4, "cm"), plot.title = element_text(size=12), legend.position = "bottom",
        plot.caption = element_text(hjust = 0, size = 9, face = "italic"))+
...
##YFT
ggplot(data=df.1998, aes(group = cluster.Ward, y= (YFT))) + geom_boxplot(aes(fill = as.factor(cluster.Ward))) + scale_fill_manual(breaks = c(0:15), values = Clusters.col, labels = c(0:15)) + labs(title = "YFT by cluster", subtitle = "Year 1998") + theme_minimal() +
  theme(axis.text = element_text(size=9), axis.title = element_text(size = 10), 
        legend.text = element_text(size=10), legend.title = element_text(size=10), 
        legend.key.size = unit(0.4, "cm"), plot.title = element_text(size=12), legend.position = "bottom",
        plot.caption = element_text(hjust = 0, size = 9, face = "italic"))+
...
##SKJ
ggplot(data=df.1998, aes(group = cluster.Ward, y= (SKJ))) + geom_boxplot(aes(fill = as.factor(cluster.Ward))) + scale_fill_manual(breaks = c(0:15), values = Clusters.col, labels = c(0:15)) + labs(title = "SKJ by cluster",  subtitle = "Year 1998") + theme_minimal() +
  theme(axis.text = element_text(size=9), axis.title = element_text(size = 10), 
        legend.text = element_text(size=10), legend.title = element_text(size=10), 
        legend.key.size = unit(0.4, "cm"), plot.title = element_text(size=12), legend.position = "bottom",
        plot.caption = element_text(hjust = 0, size = 9, face = "italic"))+
...
#FAL
ggplot(data=df.1998, aes(group = cluster.Ward, y=FAL)) + geom_histogram() + geom_histogram(aes(fill = as.factor(cluster.Ward))) + scale_fill_manual(breaks = c(0:15), values = Clusters.col, labels = c(0:15))+ labs(title = "FAL abundance index by cluster", subtitle ="Year 1998") + theme_minimal() +
  theme(axis.text = element_text(size=9), axis.title = element_text(size = 10), 
        legend.text = element_text(size=10), legend.title = element_text(size=10), 
        legend.key.size = unit(0.4, "cm"), plot.title = element_text(size=12), legend.position = "bottom",
        plot.caption = element_text(hjust = 0, size = 9, face = "italic"))+
...
#geographic map
for(j in 1:12){
  print(ggplot() + geom_sf(data = world) + geom_point(data = df.1998[df.1998$TimePeriodID == j,], aes(x = xLon, y = yLat, color = as.factor(cluster.Ward)), pch = 15) + scale_colour_manual(breaks = c(0:15), values = Clusters.col, labels = c(0:15)) + theme_bw() + labs(title = "Year 1998", subtitle = paste("Month", j)) + coord_sf(xlim = c(-40,20), ylim = c(-25,25), expand = FALSE)+ guides(colour = guide_legend(title ="Clusters")))}
```
...
```{r }
#For TUNAS
df.medians <- df.1998 %>% group_by(cluster.Ward) %>% summarise(BET = median(BET), YFT = median(YFT), SKJ = median(SKJ), FAL = median(FAL))
...
##bind two vectors 
BET.YFT.medians <- rbind(BET.medians, YFT.medians)
df.visual <- df.1998 %>% filter(cluster.Ward %in% BET.YFT.medians)
for(j in 1:12){
  print(ggplot() + geom_sf(data = world) + geom_point(data = df.visual[df.visual$TimePeriodID == j,], aes(x = xLon, y = yLat, color = as.factor(cluster.Ward)), pch = 15) + 
          scale_colour_manual(breaks = c(0:15), values = Clusters.col, labels = c(0:15)) + 
          theme_bw() + labs(title = "High YFT and BET abundance clusters", subtitle = paste("Month", j)) + coord_sf(xlim = c(-40,20), ylim = c(-25,25), expand = FALSE)+ guides(colour = guide_legend(title ="Clusters")))}
...
## visualise in geographic space
df.visual <- df.1998 %>% filter(cluster.Ward %in% FAL.medians)
for(j in 1:12){
  print(ggplot() + geom_sf(data = world) + geom_point(data = df.visual[df.visual$TimePeriodID == j,], aes(x = xLon, y = yLat, color = as.factor(cluster.Ward)), pch = 15) + 
          scale_colour_manual(breaks = c(0:15), values = Clusters.col, labels = c(0:15)) + 
          theme_bw() + labs(title = "High FAL abundance clusters", subtitle = paste("Month", j)) + coord_sf(xlim = c(-40,20), ylim = c(-25,25), expand = FALSE)+ guides(colour = guide_legend(title ="Clusters")))}
...
#take again this df.median
df.medians <- df.1998 %>% group_by(cluster.Ward) %>% summarise(BET = median(BET), YFT = median(YFT), SKJ = median(SKJ)) %>% #create tuna vulnerability index by column
  mutate(vulnerability.tuna = round((fac.BET*BET + fac.YFT*YFT + fac.SKJ *SKJ)/((fac.BET+fac.YFT+fac.SKJ)*1000))) %>%
  mutate(vulnerability.tuna = round(rescale(vulnerability.tuna, c(1,10)))) %>% #rescale to have values between 1 and 10
  arrange(desc(vulnerability.tuna)) %>%#arrange clusters by vulnerability
  select(cluster.Ward, vulnerability.tuna) #select only 2 columns of interest
...
#bind this vulnerability value to complete dataframe for plotting catches on map
df.1998 <- df.1998 %>% inner_join(df.medians, by = "cluster.Ward")

#replot boxplots with vulnerability colors
##BET
ggplot(data=df.1998, aes(group = cluster.Ward, y=BET)) + geom_boxplot(aes(fill = as.factor(vulnerability.tuna))) + scale_fill_manual(breaks = c(1:10), values = rev(Vulnerability.col), labels = c(1:10)) + labs(title = "BET by cluster", subtitle = "Ward") + theme_minimal() +
  theme(axis.text = element_text(size=9), axis.title = element_text(size = 10), 
        legend.text = element_text(size=10), legend.title = element_text(size=10), 
        legend.key.size = unit(0.4, "cm"), plot.title = element_text(size=12), legend.position = "bottom",
        plot.caption = element_text(hjust = 0, size = 9, face = "italic"))+
...
##YFT
ggplot(data=df.1998, aes(group = cluster.Ward, y=YFT)) + geom_boxplot(aes(fill = as.factor(vulnerability.tuna))) + scale_fill_manual(breaks = c(1:10), values = rev(Vulnerability.col), labels = c(1:10)) + labs(title = "YFT by cluster", subtitle = "Ward") + theme_minimal() +
  theme(axis.text = element_text(size=9), axis.title = element_text(size = 10), 
        legend.text = element_text(size=10), legend.title = element_text(size=10), 
        legend.key.size = unit(0.4, "cm"), plot.title = element_text(size=12), legend.position = "bottom",
        plot.caption = element_text(hjust = 0, size = 9, face = "italic"))+
...
#plot maps with color based on vulnerability in r
for(j in 1:12){
  print(ggplot() + geom_sf(data = world) + geom_point(data = df.1998[df.1998$TimePeriodID == j,], aes(x = xLon, y = yLat, color = as.factor(vulnerability.tuna)), pch = 15) + scale_colour_manual(values = rev(Vulnerability.col[1:10]), breaks = c(1:10), labels = (1:10)) + theme_bw() + labs(title = "Vulnerability of tuna species", subtitle = paste("Month", j)) + coord_sf(xlim = c(-40,20), ylim = c(-25,25), expand = FALSE)+ guides(colour = guide_legend(title ="Vulnerability", subtitle = "Tuna species")))}
```
...
##create column
df.medians <- df.1998 %>% group_by(cluster.Ward) %>% summarise(BET = median(BET), YFT = median(YFT), SKJ = median(SKJ), FAL = median(FAL)) %>% #create tuna vulnerability index by column
  mutate(vulnerability.accessory = (fac.FAL*FAL)) %>% #FAL a little more since more often bycaught
  mutate(vulnerability.accessory = round(rescale(vulnerability.accessory, c(1,10)))) %>% #rescale to have values between 0 and 10
  arrange(desc(vulnerability.accessory)) %>% #arrange clusters by vulnerability
  select(cluster.Ward, vulnerability.accessory) #select only 2 columns of interest
...
#plot maps with color based on vulnerability in r
for(j in 1:12){
  print(ggplot() + geom_sf(data = world) + geom_point(data = df.1998[df.1998$TimePeriodID == j,], aes(x = xLon, y = yLat, color = as.factor(vulnerability.accessory)), pch = 15) + scale_colour_manual(breaks = c(1:10),values = rev(Vulnerability.col[1:10]), labels = (1:10)) + theme_bw() + labs(title = "Vulnerability of accessory species", subtitle = paste("Month", j)) + coord_sf(xlim = c(-40,20), ylim = c(-25,25), expand = FALSE)+ guides(colour = guide_legend(title ="Vulnerability")))}
```
...
```{r, echo=FALSE}
#Changes plot
plot(som, type = "changes", main = "1994 - 1998")
...
#Boxplots
##BET
ggplot(data=df.all, aes(group = cluster.Ward, y= (BET))) + geom_boxplot(aes(fill = as.factor(cluster.Ward))) + scale_fill_manual(breaks = c(0:15), values = Clusters.col, labels = c(0:15)) + labs(title = "BET by cluster", subtitle = "1994 - 1998") + theme_minimal() +
  theme(axis.text = element_text(size=9), axis.title = element_text(size = 10), 
        legend.text = element_text(size=10), legend.title = element_text(size=10), 
        legend.key.size = unit(0.4, "cm"), plot.title = element_text(size=12), legend.position = "bottom",
        plot.caption = element_text(hjust = 0, size = 9, face = "italic"))+
...
##YFT
ggplot(data=df.all, aes(group = cluster.Ward, y= (YFT))) + geom_boxplot(aes(fill = as.factor(cluster.Ward))) + scale_fill_manual(breaks = c(0:15), values = Clusters.col, labels = c(0:15)) + labs(title = "YFT by cluster", subtitle = "1994 - 1998") + theme_minimal() +
  theme(axis.text = element_text(size=9), axis.title = element_text(size = 10), 
        legend.text = element_text(size=10), legend.title = element_text(size=10), 
        legend.key.size = unit(0.4, "cm"), plot.title = element_text(size=12), legend.position = "bottom",
        plot.caption = element_text(hjust = 0, size = 9, face = "italic"))+
...
##SKJ
ggplot(data=df.all, aes(group = cluster.Ward, y= (SKJ))) + geom_boxplot(aes(fill = as.factor(cluster.Ward))) + scale_fill_manual(breaks = c(0:15), values = Clusters.col, labels = c(0:15)) + labs(title = "SKJ by cluster",  subtitle = "1994 - 1998") + theme_minimal() +
  theme(axis.text = element_text(size=9), axis.title = element_text(size = 10), 
        legend.text = element_text(size=10), legend.title = element_text(size=10), 
        legend.key.size = unit(0.4, "cm"), plot.title = element_text(size=12), legend.position = "bottom",
        plot.caption = element_text(hjust = 0, size = 9, face = "italic"))+
...
#FAL
ggplot(data=df.all, aes(group = cluster.Ward, y=FAL)) + geom_histogram() + geom_histogram(aes(fill = as.factor(cluster.Ward))) + scale_fill_manual(breaks = c(0:15), values = Clusters.col, labels = c(0:15))+ labs(title = "FAL abundance index by cluster", subtitle ="1994 - 1998") + theme_minimal() +
  theme(axis.text = element_text(size=9), axis.title = element_text(size = 10), 
        legend.text = element_text(size=10), legend.title = element_text(size=10), 
        legend.key.size = unit(0.4, "cm"), plot.title = element_text(size=12), legend.position = "bottom",
        plot.caption = element_text(hjust = 0, size = 9, face = "italic"))+
...
#geographic map
for(j in 1:12){
  print(ggplot() + geom_sf(data = world) + geom_point(data = df.all[df.all$TimePeriodID == j,], aes(x = xLon, y = yLat, color = as.factor(cluster.Ward)), pch = 15) + scale_colour_manual(breaks = c(0:15), values = Clusters.col, labels = c(0:15)) + theme_bw() + labs(title = "1994 - 1998", subtitle = paste("Month", j)) + coord_sf(xlim = c(-40,20), ylim = c(-25,25), expand = FALSE)+ guides(colour = guide_legend(title ="Clusters")))}
```
...
for(j in 1:12){
  print(ggplot() + geom_sf(data = world) + geom_point(data = df.visual[df.visual$TimePeriodID == j,], aes(x = xLon, y = yLat, color = as.factor(cluster.Ward)), pch = 15) + 
          scale_colour_manual(breaks = c(0:15), values = Clusters.col, labels = c(0:15)) + 
          theme_bw() + labs(title = "High YFT and BET abundance clusters", subtitle = paste("1994 - 1998, month", j)) + coord_sf(xlim = c(-40,20), ylim = c(-25,25), expand = FALSE)+ guides(colour = guide_legend(title ="Clusters")))}
```
...
for(j in 1:12){
  print(ggplot() + geom_sf(data = world) + geom_point(data = df.visual[df.visual$TimePeriodID == j,], aes(x = xLon, y = yLat, color = as.factor(cluster.Ward)), pch = 15) + 
          scale_colour_manual(breaks = c(0:15), values = Clusters.col, labels = c(0:15)) + 
          theme_bw() + labs(title = "High FAL abundance clusters", subtitle = paste("1994 - 1998, month", j)) + coord_sf(xlim = c(-40,20), ylim = c(-25,25), expand = FALSE)+ guides(colour = guide_legend(title ="Clusters")))}
```
...
#replot boxplots with vulnerability colors
##BET
ggplot(data=df.all, aes(group = cluster.Ward, y=BET)) + geom_boxplot(aes(fill = as.factor(vulnerability.tuna))) + scale_fill_manual(breaks = c(1:10), values = rev(Vulnerability.col), labels = c(1:10)) + labs(title = "BET by cluster", subtitle = "1994 - 1998") + theme_minimal() +
  theme(axis.text = element_text(size=9), axis.title = element_text(size = 10), 
        legend.text = element_text(size=10), legend.title = element_text(size=10), 
        legend.key.size = unit(0.4, "cm"), plot.title = element_text(size=12), legend.position = "bottom",
        plot.caption = element_text(hjust = 0, size = 9, face = "italic"))+
...
##YFT
ggplot(data=df.all, aes(group = cluster.Ward, y=YFT)) + geom_boxplot(aes(fill = as.factor(vulnerability.tuna))) + scale_fill_manual(breaks = c(1:10), values = rev(Vulnerability.col), labels = c(1:10)) + labs(title = "YFT by cluster", subtitle = "1994 - 1998") + theme_minimal() +
  theme(axis.text = element_text(size=9), axis.title = element_text(size = 10), 
        legend.text = element_text(size=10), legend.title = element_text(size=10), 
        legend.key.size = unit(0.4, "cm"), plot.title = element_text(size=12), legend.position = "bottom",
        plot.caption = element_text(hjust = 0, size = 9, face = "italic"))+
...
#plot maps with color based on vulnerability in r
for(j in 1:12){
  print(ggplot() + geom_sf(data = world) + geom_point(data = df.all[df.all$TimePeriodID == j,], aes(x = xLon, y = yLat, color = as.factor(vulnerability.tuna)), pch = 15) + scale_colour_manual(values = rev(Vulnerability.col[1:10]), breaks = c(1:10), labels = (1:10)) + theme_bw() + labs(title = "Vulnerability of tuna species", subtitle = paste("1994 - 1998, month", j)) + coord_sf(xlim = c(-40,20), ylim = c(-25,25), expand = FALSE)+ guides(colour = guide_legend(title ="Vulnerability")))}
```
...
#plot maps with color based on vulnerability in r
for(j in 1:12){
  print(ggplot() + geom_sf(data = world) + geom_point(data = df.all[df.all$TimePeriodID == j,], aes(x = xLon, y = yLat, color = as.factor(vulnerability.accessory)), pch = 15) + scale_colour_manual(breaks = c(1:10),values = rev(Vulnerability.col[1:10]), labels = (1:10)) + theme_bw() + labs(title = "Vulnerability of juvenile silky sharks", subtitle = paste("1994 - 1998, month", j)) + coord_sf(xlim = c(-40,20), ylim = c(-25,25), expand = FALSE)+ guides(colour = guide_legend(title ="Vulnerability")))}
```
...
# Only month of april, 1994 - 1998 (not during moratoria)
...
# Only month of December, 1994 - 1998 (not during moratoria)
## Center and scale data, select parameters
```{r, echo=TRUE }
#select year 1997
...
# Only month of February, 1994 - 1998 (2nd moratoria month)
### Center and scale data, select parameters
```{r, echo=TRUE }
#select year 1997
